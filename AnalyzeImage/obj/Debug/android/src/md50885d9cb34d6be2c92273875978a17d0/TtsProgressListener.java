package md50885d9cb34d6be2c92273875978a17d0;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.TextToSpeech.TtsProgressListener, Plugin.TextToSpeech, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", TtsProgressListener.class, __md_methods);
	}
	...
	public TtsProgressListener () throws java.lang.Throwable
	{
		...
		if (getClass () == TtsProgressListener.class)
			mono.android.TypeManager.Activate ("Plugin.TextToSpeech.TtsProgressListener, Plugin.TextToSpeech, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
